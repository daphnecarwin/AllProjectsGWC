...
jinja_environment = jinja2.Environment(loader = jinja2.FileSystemLoader(template_directory)) #creating Jinja object
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        template = jinja_environment.get_template('index.html') #specify what HTML file to server
        self.response.out.write(template.render(number = anotherNumber, list= exampleList)) #server template
